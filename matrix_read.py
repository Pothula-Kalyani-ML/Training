'''import os
file_path = os.path.join(os.getcwd(), 'inputfile','f1')
print(file_path)
with open(file_path,"r") as readf:
   out= readf.readlines()
   print(out)

   mat=[ l for l in out while l =='\n' ]
   print(mat)
   '''
import os
...
def read_matrix_from_file(file_name):
    file_path = os.path.join(os.getcwd(), 'inputfile', file_name)
